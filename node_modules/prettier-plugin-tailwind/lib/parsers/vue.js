...
exports.default = (twClassesSorter) => (Object.assign(Object.assign({}, parser_html_1.default.parsers.vue), { parse(text, parsers, options) {
        const ast = parser_html_1.default.parsers.vue.parse(text, parsers, options);
        if (!twClassesSorter) {
            return ast;
        }
