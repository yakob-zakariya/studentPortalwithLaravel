<template>
  <div>
    <Head title="Users" />
    <h1 class="mb-8 text-3xl font-bold">Registrar Users</h1>
    <div class="flex items-center justify-between mb-6">
      ...
      <Link class="btn-indigo" :href="route('admin.registrars.create')">
        <span>Create </span>
        <span class="hidden md:inline">&nbsp;Registrar User</span>
      </Link>
    </div>
    <div class="overflow-x-auto bg-white rounded-md shadow">
      <table class="w-full whitespace-nowrap">
        ...
        <tr v-for="(user,index) in users" :key="user.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          <td class="border-t">
            <Link class="flex items-center px-6 py-4 focus:text-indigo-500" :href="route('admin.registrars.edit',user)">
          ...
          <td class="border-t">
            <Link class="flex items-center px-6 py-4" :href="route('admin.registrars.edit',user)" tabindex="-1">
              {{ user.email }}
            </Link>
          </td>
          <td class="border-t">
          ...
          <td class="w-px border-t">
            <Link class="flex items-center px-4" :href="route('admin.registrars.edit',user)" tabindex="-1">
