<template>
  <div>
    ...
    <h1 class="mb-8 text-3xl font-bold">
      ...
      <span class="font-medium text-indigo-400">/</span> Choose Semster to allocate courses
    </h1>
    <div class="max-w-4xl overflow-hidden bg-white rounded-md shadow">
      <form @submit.prevent="store">
        <div class="flex flex-wrap p-8 -mb-6 -mr-6">
          ...
          <!-- Select Batch -->
          <select-input v-model="form.batch_id" :error="form.errors.batch_id" class="w-full pb-8 pr-6 lg:w-1/2" label="Select Batch">
            <option :value="null" />
