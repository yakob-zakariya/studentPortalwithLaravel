      ...
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:shrink-0">
          <div class="flex items-center justify-between px-6 py-4 bg-indigo-900 md:shrink-0 md:justify-center md:w-56">
            ...
            <dropdown class="md:hidden" placement="top-right">
              <template #default>
              ...
              <template #dropdown>
                <div class="px-2 py-4 mt-2 bg-indigo-800 rounded shadow-lg">
                  <main-menu />
                </div>
              </template>
            </dropdown>
          ...
          <div class="flex items-center justify-between w-full p-4 text-sm bg-white border-b md:text-md md:px-12 md:py-0">
            <div class="mt-1 mr-4">department heads Portal</div>
        ...
        <div class="md:flex md:grow md:overflow-hidden">
          <main-menu class="hidden w-56 overflow-y-auto bg-indigo-800 shrink-0 md:block" />
